...
- What remains to be done:
  ...
  - Fix the links called in [main html code](./index.html), in [main css](./assets/css/2455f5211be05b218519.css) and in [d0f410feafebf36c8443.js](./assets/js/d0f410feafebf36c8443.js) and probably a few more, either to download the file and put it in ```assets```, or to remove it as it has no function or fix the alternation of languages in navbar, etc.
